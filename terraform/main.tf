...
module "phase-two" {
    ...
    EMAIL_SCHEDULER_ROLE_NAME = var.EMAIL_SCHEDULER_ROLE_NAME
    EMAIL_SCHEDULER_POLICY_NAME = var.EMAIL_SCHEDULER_POLICY_NAME
    EMAIL_SCHEDULER_NAME = var.EMAIL_SCHEDULER_NAME
}